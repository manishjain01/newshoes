...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            {!! Form::model($newsletter,['method'=>'patch','route'=>['admin.newsletter.update',$newsletter->id]]) !!}
            ...
            <div class="box-footer">
                <div class="pull-right">
                    ...
                    {!!  Html::decode(Html::link(route('admin.newsletter.index'),trans('admin.CANCEL'),['class'=>'btn btn-default'])) !!}
