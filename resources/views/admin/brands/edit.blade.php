...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box-header with-border">
            <h3 class="pull-right">  
                {!!  Html::decode(Html::link(route('admin.brands.index'),"<i class='fa  fa-arrow-left'></i>".trans('admin.BACK'),['class'=>'btn btn-block btn-primary'])) !!}
            </h3>
        </div>
        <!-- SELECT2 EXAMPLE -->
        <div class="box box-primary">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group ">
                                {!! Form::label('Brand Name',null,['class'=>'required_label']) !!}
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
            ...
            <div class="box-footer">
                <div class="pull-right">
                    ...
                    {!!  Html::decode(Html::link(route('admin.brands.index'),trans('admin.CANCEL'),['class'=>'btn btn-default'])) !!}
