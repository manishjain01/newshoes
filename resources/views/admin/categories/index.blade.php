...
<section class="content-header">
  ...
  {!!  Html::decode(Html::link(route('admin.categories.create'),"<i class='fa  fa-plus'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('Add')])) !!}				  
...
<!--                  <th  width="15%" align="center">{{trans('admin.PROFILE_IMAGE')}}</th>-->
              <th width="5%">S.No</th>
              <th width="15%">@sortablelink('cat_name', 'Category Name')</th>
           ...
           <tr>
              ...
              <td>
				  {!!  Html::decode(Html::link(route('admin.categories.edit', $category->id),"<i class='fa  fa-edit'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>trans('admin.EDIT')])) !!}				  
                            ...
                            {!! Form::close() !!}<?php */?>
                            {!!  Html::decode(Html::link(route('admin.subindex', $category->slug),"<i class='fa fa-th'></i>",['class'=>'btn btn-primary','data-toggle'=>'tooltip','title'=>'Sub Category'])) !!}
              </td>
           </tr>
           <?php $i++;?>
            @endforeach
