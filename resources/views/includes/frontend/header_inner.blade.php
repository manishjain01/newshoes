                    ...
                    <ul id="wishlist_dropdown"> 
                        ...
                        <li <?php if($value->status == 0){?>class="wishlist_block"<?php }?>>
                            <a href="{{URL::to('productDetail/'.$value->slug.'/'.$colorLists->slug)}}">
                                ...
                                <span class="wishlist_price"><i class="fa fa-inr" aria-hidden="true"></i> <b>{{$value->price}}</b></span>
                                <span class="price"><i class="fa fa-inr" aria-hidden="true"></i> <b>{{$discount_price}}</b></span>
                            </a>
                        </li>   
                        @endforeach
                    </ul>
        ...
        <div class="collapse navbar-collapse col-md-8 col-xs-2" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li class="form_li">
                    ...
                    {!! Form::open(array('route' => 'product_search', 'novalidate' => 'novalidate', 'id' => 'form_serch1','class'=>'form-inline form_serch1')) !!}
                    <div class="form-group">
                        <input type="search" id="search" class="form-control" placeholder="Search by product name" name="search">
