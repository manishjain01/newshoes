<section class="footer">
         <div class="container">
            ...
            <div class="col-md-4 block animatable moveUp">
               ...
               <p>{{Configure('CONFIG_FROMEMAIL')}}</p>
            </div>
            <div class="col-md-5 block animatable bounceInRight">
                <h3>Subscribe For Newsletter</h3>
            {!! Form::open(array('novalidate' => 'novalidate','files'=>true,'id'=>'newsletter_form' ,'class' =>'form-inline')) !!}
               ...
               <div class="col-md-12 social_f">
                  <p>
                     <a href="{{Configure('CONFIG_FACEBOOK')}}" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a> 
                     <a href="{{Configure('CONFIG_LINKEDIN')}}" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a> 
                     <a href="{{Configure('CONFIG_INSTAGRAM')}}" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                  </p>
               </div>
            </div>
         </div>
