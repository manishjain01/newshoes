...
<!--                     <a href="#" class="share">Share 
                  ...
                  <div class="col-md-12 prices2">
                    ...
                    <ul>
                        ...
                        @if($sizes['quantity'] == 0)
                        <li><a href="javascript::void(0);" ><strike>{{$size[0]['size']}}</strike></a></li>
                        @else
...
<!--                              <button class="btn btn-default by_now" attrId="$productDetail[0]['id']">BUY NOW</button>-->
                  ...
                  <div class="col-md-6 btn_dtl">
                    ...
                    @if(isset($wishlist['0']['id']) && !empty($wishlist['0']['id']))
                     <a href="javascript::void(0);" attrId="{{$productDetail[0]['id']}}" attrColor ="{{$colorId}}" class="btn_continue1 btn_continue2 wish_deail wishBtnManageColor wishlist_btn_red wishlist-btn-color"><span>Add to Wish Cart</span></a>
                    @else
                     <a href="javascript::void(0);" attrId="{{$productDetail[0]['id']}}" attrColor ="{{$colorId}}" class="btn_continue1 btn_continue2 wish_deail wishlist_btn wishBtnManageColor"  style="color:black;"><span>Add to Wish Cart</span></a>
                     @endif
                     @else
                  ...
                  <table class="speci_p">
                    ...
                    @foreach(array_intersect_key($productDetail[0]['product_color'], $ss) as $key=>$value)
                     ...
                     <tr>
                        <td>Color</td>
                        <td>
                        @foreach($productDetail[0]['product_color'] as $key=>$value)
                                    <?php $color = CommonHelpers::getColor($value['color_id']);
                                    ?>
                     ...
                     <div class="carousel-grid col-lg-3 col-md-4 col-sm-12 ">
                        <div class="d-block w-100">
                           <div class="container_hv">
                              <img class="image_hv" src="{{PRODUCT_IMAGE_URL.$relatedProduct['product_image'][0]['image_name']}}" alt="First slide">
                              <div class="overlay_hv">
                                 <div class="text_hv">
                                    <p>
                                        @if(Auth::check())
                           <?php $auth = LoginUser();
                              $wishlist = CommonHelpers::wishlist_list($auth->id, $relatedProduct['id'], $relatedProduct['product_image'][0]['color_id']);
                              ?>
                           @if(isset($wishlist['0']['id']) && !empty($wishlist['0']['id']))
                           <a href="javascript:void(0);" id="wishlist_btn_red" attrId="{{$relatedProduct['id']}}" attrColor ="{{$relatedProduct['product_image'][0]['color_id']}}" class="last_icn wishBtnManageColor wishlist_btn_red wishlist-btn-color slct">
                           <i class="fa fa-heart" aria-hidden="true"></i>
                           </a>
                           @else 
                           <a href="javascript:void(0);" id="wishlist_btn" attrId="{{$relatedProduct['id']}}" attrColor ="{{$relatedProduct['product_image'][0]['color_id']}}" class="last_icn wishlist_btn wishBtnManageColor slct">
                           <i class="fa fa-heart" aria-hidden="true"></i>
                           </a>
                           @endif
                           @else
...
<!--                                       <a href="javascript:void(0);" class="slct">
                           ...
                           <div class="dlt">
                              ...
                              <p class="price"><span><i class="fa fa-inr" aria-hidden="true"></i> 
                                      {{$relatedProduct['price']}} </span> 
                                  <i class="fa fa-inr" aria-hidden="true"></i> {{$discount_price}}</p>
