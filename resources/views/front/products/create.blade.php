        ...
        <div class="row">
            ...
            <div class="col-md-9 Edit_form_area">
                ...
                <div class="registration_form_s">
                    ...
                    <!--{!! Form::label('Profile img1',null,['class'=>'required_label']) !!}-->
                    <div class="col-md-2">
                        <div class="form-group create-img">
                            ...
                            <span>
                                <?php if (!empty($user->profile_img1)) { ?>
                                    <label for="profile_img1">
                                        <img src="public/uploads/{{ $user->profile_img1 }}" id="img1" alt="" class="" width="50" />
                                    </label>
                                <?php } else { ?>
                                    <label for="profile_img1">
                    ...
                    <div class="col-md-10">
						...
						{!! Form::label(trans('front.PRODUCT_IMG_DES1'),null,['class'=>'']) !!}
                            {!! Form::textarea ('description1',null,['class'=>'form-control', 'rows'=>"3",'placeholder'=>trans('front.PRODUCT_IMG_DES1').'1' ]) !!}
                    ...
                    <div class="col-md-2">
                        <div class="form-group create-img">
                            ...
                            <span>
                                <?php if (!empty($user->profile_img2)) { ?>
                                    <label for="profile_img2">
                                        <img src="public/uploads/{{ $user->profile_img2 }}" id="img2" alt="" class="" width="50" />
                                    </label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group create-img">
                            ...
                            <span>
                                <?php if (!empty($user->profile_img3)) { ?>
                                    <label for="profile_img3">
                                        <img src="public/uploads/{{ $user->profile_img3 }}" id="img3" alt="" class="" width="50" />
                                    </label>
                                <?php } else { ?>
                                    <label for="profile_img3">
                    ...
                    <div class="col-md-2">
                        <div class="form-group create-img">
                            ...
                            <span>
                                <?php if (!empty($user->profile_img4)) { ?>
                                    <label for="profile_img4">
                                        <img src="public/uploads/{{ $user->profile_img4 }}" id="img4" alt="" class="" width="50" />
                                    </label>
                                <?php } else { ?>
                                    <label for="profile_img4">
                    ...
                    <div class="col-md-2">
                        <div class="form-group create-img">
                            ...
                            <span>
                                <?php if (!empty($user->profile_img5)) { ?>
                                    <label for="profile_img5">
                                        <img src="public/uploads/{{ $user->profile_img5 }}" id="img5" alt="" class="" width="50" />
                                    </label>
                                <?php } else { ?>
                                    <label for="profile_img5">
                    ...
                    <div class="form-group">
                        {!! Form::radio('piercing', 'YES', ['class' => '']) !!}&nbsp;{{ trans('front.YES')}}&nbsp;&nbsp;
                        {!! Form::radio('piercing', 'NO', ['class' => '']) !!}&nbsp;{{ trans('front.NO')}}
                        <div class="error">{{ $errors->first('piercing') }}</div>
                    </div>
                    {!! Form::label(trans('front.TATOOS'),null,['class'=>'']) !!}
                    <div class="form-group">
                        {!! Form::radio('tatoos', 'YES', ['class' => '']) !!}&nbsp;{{ trans('front.YES')}}&nbsp;&nbsp;
                        {!! Form::radio('tatoos', 'NO', ['class' => '']) !!}&nbsp;{{ trans('front.NO')}}
                    ...
                    <div class="reg_chose form-group">
                        <div class="col-md-4">
                        {!!  Html::decode(Html::link(route('myaccount'),trans('front.CANCEL'),['class'=>'btn btn-primary btn_can btn-center new1'])) !!}
                        </div>
                        <div class="col-md-4 inner-reset">
                        {!! Form::reset(trans('front.RESET'), null, ['class' => 'form-control reset_button btn btn-primary btn_can btn-center new1', 'id' => 'resetForm']) !!}
                        </div>
                        <div class="col-md-4 inner-reset">
                        {!! Form::submit(trans('front.ADD_PRODUCT'),['class'=>'btn form-control login_btn new1','id'=>'registration_form1'])!!}
                        </div>
