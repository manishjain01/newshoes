...
<?php 
        ...
        <div class="row check_out1" >
            ...
            <div class="col-md-12 btm_dvv">  
                ...
                <div class="col-md-12 address_showw block animatable bounceInLeft">
                    ...
                    <div class="col-md-6">
                        <a href="{{URL::to('delivery_address',$order_no)}}/guest" <?php  if(isset($isdisabled) && $isdisabled != 1){?>disabled="disabled" style="display:none;"<?php }?>>
     ...
     <!--                <p>Jaipur &nbsp;&nbsp;&nbsp; 335012</p>
                     <p>Mobile &nbsp;&nbsp;&nbsp; 9857421245</p>-->
                        ...
                        <a href="{{URL::to('delivery_address',$order_no)}}/guest" >Edit</a>
