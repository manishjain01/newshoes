    ...
    <!--////  new arivel shoes/////-->
        <div class="container-fluid text-center py-5 my-5">
            ...
            <div class="row mx-auto my-auto animatable bounceIn">
             ...
             <!-- The Modal -->
<div id="myModal_view" class="modal_view">
...
<div class="mySlides_modal fade_modal">
...
">
  <span class="dot_modal" onclick="currentSlide_modal(1)"></span> 
  <span class="dot_modal" onclick="currentSlide_modal(2)"></span> 
  <span class="dot_modal" onclick="currentSlide_modal(3)"></span> 
</div>
...
function showSlides_modal(n)
 {
  var i;
  var slides_modal = document.getElementsByClassName("mySlides_modal");
  var dots_modal = document.getElementsByClassName("dot_modal");
               ...
               success: function (msg) {
                   ...
                   $.each(msg1.data, function (key, value) {
                    ...
                    //$(".rahImg"+attId).attr("src",url+image);
                       html.push('<img src="' + url + value.image_name + '" class = "rahImg'+attId+'">');
