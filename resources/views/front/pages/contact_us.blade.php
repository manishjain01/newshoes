        ...
        <div class="row">
         ...
         <div class="row address_row contact_fromm">
            <div class="col-md-6">
                ...
                {!! Form::open(['route'=>'contact_us_post','class'=>'frm_cnt']) !!} 
                ...
                <div class="form-group">
                    {!! Form::textarea('message',null,['class'=>'form-control textarea','maxlength'=>'500','placeholder'=>'Enter Message Character Limit 500']) !!}
