                ...
                <div class="products-wrapper">
                    <div class="product-category-filter-wrap">
                        ...
                        @foreach($latest_products as $key=> $latest_product) <?php //pr($latest_product);echo "adfa";exit;?>
                         <?php $colorLists = CommonHelpers::getProductColor($latest_product->product_image[0]['color_id']);?>
                        ...
                        <div class="col-md-4 single-product-wrap men kid bagshoes">
                            <figure class="product-thumbnail">
                                ...
                                <?php if(isset($latest_product->product_image[1]) && !empty($latest_product->product_image[1])) {?>
                                <img class="secondary-thumb" src="{{PRODUCT_IMAGE_URL.$latest_product->product_image[1]['image_name']}}" alt="Product"/>
                               <?php }else{?>
...
<div class="col-md-9 slideshow-container">
	...
	<?php $colorLists = CommonHelpers::getProductColor($featured_product->product_image[0]['color_id']);?>
        ...
        <div class="row no-gutters">
            <div class="col-lg-12">
			 ...
			 <?php $colorLists = CommonHelpers::getProductColor($random_product->product_image[0]['color_id']);?>		
					...
					@if(isset($random_product->product_image[1]) && !empty($random_product->product_image[1]))
                                    <img class="primary-thumb" src="{{PRODUCT_IMAGE_URL.$random_product->product_image[1]['image_name']}}" alt="Product"/>
                                    @else
                                    <img class="primary-thumb" src="{{asset('img/no-image.png')}}" alt="Product"/>
                                    @endif
