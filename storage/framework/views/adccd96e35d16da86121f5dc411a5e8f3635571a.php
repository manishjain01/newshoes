...
<?php $__env->startSection('content'); ?>
     <?php //pr($latest_products);exit;?>
      ...
      <section class="serch_row block animatable bounceInLeft">
         <div class="container">
            <div class="row">
                <?php echo Form::open(array('route' => 'product_search', 'novalidate' => 'novalidate', 'id' => 'form_serch1','class'=>'form-inline form_serch form_serch1')); ?>
            ...
            <div class="row">
               <div class="col-md-6 block animatable bounceInLeft">
                  ...
                  <div class="col-md-12 cat_cl">
                     <h2><?php echo e($womens_cat->cat_name); ?></h2>
                     <p><a href="javascript:void(0)">FOOTWEAR</a><a href="javascript:void(0)">WALLETS</a><a href="javascript:void(0)">BELTS</a></p>
                     <a href="<?php echo e(URL::to('productCat/'.$womens_cat->slug)); ?>" class="shop_btn"><span>SHOP NOW</span></a> 
                  </div>
               </div>
               <div class="col-md-6 block animatable bounceInRight">
                  <img src="img/men.jpg">  
                  <div class="col-md-12 cat_cl">
                     <h2><?php echo e($mens_cat->cat_name); ?></h2>
                     <p><a href="javascript:void(0)">FOOTWEAR</a><a href="javascript:void(0)">WALLETS</a><a href="javascript:void(0)">BELTS</a></p>
                     <a href="<?php echo e(URL::to('productCat/'.$mens_cat->slug)); ?>" class="shop_btn"><span>SHOP NOW</span></a> 
                  </div>
               </div>
            </div>
         </div>
                        ...
                        <div class="carousel-item <?php if($key == 0){?>active<?php }?>">
                           <div class="d-block  col-12 col-sm-6 col-md-4 col-lg-3">
                               <div class="d-block w-100">
                                ...
                                <img class="image_hv" src="<?php echo e(PRODUCT_IMAGE_URL.$latest_product->product_image[0]['image_name']); ?>" alt="Product"/>
                               <?php }else{?>
                                <img class="image_hv" src="<?php echo e(asset('img/no-image.png')); ?>" alt="Product"/>
                               <?php }?>
                                      ...
                                      <div class="overlay_hv">
                                         <div class="text_hv">
                                            <p>
                                                ...
                                                <a href="javascript:void(0);" id="wishlist_btn_red" attrId="<?php echo e($latest_product->id); ?>" attrColor ="<?php echo e($latest_product->product_image[0]['color_id']); ?>" class="last_icn wishBtnManageColor wishlist_btn_red wishlist-btn-color slct">
                                                    <i class="fa fa-heart" aria-hidden="true"></i>
                                                    </a>
                                                <?php else: ?>
                                                <a href="javascript:void(0);" id="wishlist_btn" attrId="<?php echo e($latest_product->id); ?>" attrColor ="<?php echo e($latest_product->product_image[0]['color_id']); ?>" class="last_icn wishlist_btn wishBtnManageColor slct">
                                                <i class="fa fa-heart" aria-hidden="true"></i>
                                                </a>
                                                <?php endif; ?>
                                                ...
                                                <?php endif; ?>
                                               <a id="myBtn_view" attId="<?php echo e($key); ?>" proId="<?php echo e($latest_product->id); ?>" colorId ="<?php echo e($latest_product->product_image[0]['color_id']); ?>" class="view_btn_class slct">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a> 
                                               <!--  <a id="myBtn_view" class=" slct">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a> -->
                                                 <!-- <a href="#"  class="slct" data-toggle="modal" data-target="#myModal_view_pro<?php echo e($latest_product->id); ?>">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a> -->
                                              <!-- <a href="<?php echo e(URL::to('productDetail/'.$latest_product->slug.'/'.$colorLists->slug)); ?>" class="slct" data-toggle="modal" data-target="#myModal_view_pro"><i class="fa fa-eye" aria-hidden="true"></i></a>  -->
                                              <!--  <a href="<?php echo e(URL::to('productDetail/'.$latest_product->slug.'/'.$colorLists->slug)); ?>" class="slct" data-toggle="modal" data-target="#myModal_view_pro"><i class="fa fa-eye" aria-hidden="true"></i></a> -->
                                            </p>
                                            <p class="shop_nw">
                                                <a href="<?php echo e(URL::to('productDetail/'.$latest_product->slug.'/'.$colorLists->slug)); ?>">SHOP THIS</a>
                                            </p>
                                         </div>
                                      </div>
                                   </div>
                                   <div class="dlt">
                                      <h3 class="prduct_title1"><?php echo e($latest_product->product_title); ?></h3>
                                      ...
                                      <p class="price">
                                              ...
                                              <span><i class="fa fa-inr" aria-hidden="true"></i> <?php echo e($latest_product->price); ?> </span>
                                              <?php endif; ?>
     ...
     <div class="container-fluid text-center py-5 my-5">
            ...
            <div class="row mx-auto my-auto animatable bounceIn">
                <div id="recipeCarousel1" class="carousel carousel1 slide w-100" data-ride="carousel">
                    <div class="container carousel-inner carousel-inner1  w-100" role="listbox">
                        <?php if($featured_products_count > 4 ): ?>
                        ...
                        <div class="carousel-item <?php if($key == 0){?>active<?php }?>">
                           <div class="d-block  col-12 col-sm-6 col-md-4 col-lg-3">
                               <div class="d-block w-100">
                                ...
                                <img class="image_hv" src="<?php echo e(PRODUCT_IMAGE_URL.$featured_product->product_image[0]['image_name']); ?>" alt="Product"/>
                               <?php }else{?>
                                <img class="image_hv" src="<?php echo e(asset('img/no-image.png')); ?>" alt="Product"/>
                               <?php }?>
                                         ...
                                         <div class="text_hv">
                                            <p>
                                                ...
                                                <?php $auth = LoginUser();
                                                   ...
                                                   ?>
                                                <?php if(isset($wishlist['0']['id']) && !empty($wishlist['0']['id'])): ?>
                                                <a href="javascript:void(0);" id="wishlist_btn_red" attrId="<?php echo e($featured_product->id); ?>" attrColor ="<?php echo e($featured_product->product_image[0]['color_id']); ?>" class="last_icn wishBtnManageColor wishlist_btn_red wishlist-btn-color slct">
                                                    <i class="fa fa-heart" aria-hidden="true"></i>
                                                    </a>
                                                <?php else: ?>
                                                <a href="javascript:void(0);" id="wishlist_btn" attrId="<?php echo e($featured_product->id); ?>" attrColor ="<?php echo e($featured_product->product_image[0]['color_id']); ?>" class="last_icn wishlist_btn wishBtnManageColor slct">
                                                <i class="fa fa-heart" aria-hidden="true"></i>
                                                </a>
                                                <?php endif; ?>
                                                ...
                                                <a href="javascript:void(0);" class="slct wishlist_btn" data-toggle="modal" data-target="#myModal" title="Add to wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                <?php endif; ?>
                                                 <a id="myBtn_view" attId="<?php echo e($key); ?>"  proId="<?php echo e($featured_product->id); ?>" colorId ="<?php echo e($featured_product->product_image[0]['color_id']); ?>" class="view_btn_class2 slct">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a> 
<!--                                               <a href="<?php echo e(URL::to('productDetail/'.$featured_product->slug.'/'.$colorLists->slug)); ?>" class="slct">
                                                   <i class="fa fa-eye" aria-hidden="true"></i>
                                               </a>-->
                                            </p>
                                            <p class="shop_nw">
                                                <a href="<?php echo e(URL::to('productDetail/'.$featured_product->slug.'/'.$colorLists->slug)); ?>">SHOP THIS</a>
                                            </p>
                                         </div>
                                      </div>
                                   </div>
                                   <div class="dlt">
                                      <h3 class="prduct_title1"><?php echo e($featured_product->product_title); ?></h3>
                                      ...
                                      <p class="price">
                                              ...
                                              <span><i class="fa fa-inr" aria-hidden="true"></i> <?php echo e($featured_product->price); ?> </span>
                                              <?php endif; ?>
...
$(document).ready(function(){
 $('.view_btn_class').click(function($event){
	...
	//images 	  = JSON.parse(images);
        ...
        $.ajax({
               type: "POST",
               url: '<?php echo e(URL::to("/")); ?>/image_prew',
               cache: false,
