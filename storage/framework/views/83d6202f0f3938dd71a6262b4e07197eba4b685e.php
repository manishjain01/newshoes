      ...
      <div class="col-md-9">
          <div class="row show_rslt block animatable bounceInRight">
               <ul class="col-md-8">
                   ...
                   ?>                 
<!--              <p class="cl-md-4">Showing <?php echo e($i+1); ?>–<?php echo e($products2->count()); ?> of <?php echo e($products2->total()); ?> results</p>-->
            ...
            <div class="col-md-12 block animatable moveUp">
               ...
               <div class="value1" id="panel_gndr" style="display: none;">
                  <span id="dots_in"></span>                    
                      <?php foreach($main_lists as $key=>$catList): ?>
                     <div class="form-group">
                        <label class="container_check1"><?php echo e(ucfirst($catList->cat_name)); ?>

                            <input   type="checkbox" name="man_cats[]" value="<?php echo e($catList->id); ?>" <?php if(in_array($catList->id,$mancatArr)){?> checked="checked" <?php }?>>
            ...
            <div class="col-md-12 block animatable moveUp">
               ...
               <div class="value1" id="panel_brand" style="display: none;">
                 ...
                 <?php foreach($brands as $key=>$brand): ?>
                     <div class="form-group">
                        <label class="container_check1"><?php echo e(ucfirst($brand->brand_name)); ?>

                        <input type="checkbox" name="brands[]" value="<?php echo e($brand->id); ?>" <?php if(in_array($brand->id,$brandArr)){?> checked="checked" <?php }?> />
             ...
             <div class="col-md-12 block animatable moveUp">
               ...
               <div class="value1" id="panel_color" style="display: none;">
                  ...
                  <div class="p">
                     ...
                     <div class="form-group">
                        <label class="container_check1"><span class="colors clr1" style="background:<?php echo e($colorList->color_picker); ?>;"></span> <?php echo e(ucfirst($colorList->color_name)); ?>
               ...
               <div class="value1" id="panel_size" style="display: none;">
                  <span id="dots_in5"></span>
                     ...
                     <div class="p">
                        ...
                        <div class="form-group">
                           <label class="container_check1"><?php echo e($value->size); ?>
         ...
         <div class="col-md-9 list_produ">
            ...
            <?php $colorLists = CommonHelpers::getProductColor_image($product->color_id, $product->id);
                  //$colorLists = CommonHelpers::getProductColor($product->color_id);
                     ...
                     //pr($colorLists);
                     ?>
            <?php if(isset($images) && !empty($images) && !empty($colorLists)): ?>
            <div class="col-md-4 block animatable moveUp">
               <div class="container_hv">
                  
                  <?php if(!empty($images[0])): ?>  
                  <img class="image_hv" src="<?php echo e(PRODUCT_IMAGE_URL.$images[0]['image_name']); ?>" alt="<?php echo e($product->product_title); ?>"/>
                  <?php else: ?>
                  <img class="image_hv" src="<?php echo e(asset('img/no-image.png')); ?>" alt="<?php echo e($product->product_title); ?>"/>
                  <?php endif; ?>
                  <div class="overlay_hv">
                     <div class="text_hv">
                        <p>
                           ...
                           <a href="javascript:void(0);" id="wishlist_btn_red" attrId="<?php echo e($product->id); ?>" attrColor ="<?php echo e($product->color_id); ?>" class="last_icn wishBtnManageColor wishlist_btn_red wishlist-btn-color slct">
                           <i class="fa fa-heart" aria-hidden="true"></i>
                           </a>
                           <?php else: ?> 
                           <a href="javascript:void(0);" id="wishlist_btn" attrId="<?php echo e($product->id); ?>" attrColor ="<?php echo e($product->color_id); ?>" class="last_icn wishlist_btn wishBtnManageColor slct">
                           <i class="fa fa-heart" aria-hidden="true"></i>
                           </a>
                           <?php endif; ?>
                           <?php else: ?>
...
<!--                           <a href="#" class="slct"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>-->
                           <a href="<?php echo e(URL::to('productDetail/'.$product->slug.'/'.$colorLists->slug)); ?>" class="slct"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        </p>
                        <p class="shop_nw"><a href="<?php echo e(URL::to('productDetail/'.$product->slug.'/'.$colorLists->slug)); ?>">SHOP THIS</a></p>
                     </div>
                  </div>
               </div>
               <div class="dlt">
                  <h3 class="prduct_title1"><a class="pro_title_new" href="<?php echo e(URL::to('productDetail/'.$product->slug.'/'.$colorLists->slug)); ?>"><?php echo e($product->product_title); ?></a></h3>
                  ...
                  <p class="price">
                      ...
                      <span><i class="fa fa-inr" aria-hidden="true"></i> <?php echo e($product->price); ?> </span>
                      <?php endif; ?>
...
<!--                  <p class="size"><a href="#">5</a> <a href="#">6</a> <a href="#">7</a> <a href="#">8</a></p>-->
            ...
            <div class="col-md-12 pg_ni">
                ...
                <ul>
            <?php echo $products2->appends(Input::all('page'))->render(); ?></ul></div>
            <?php else: ?>
