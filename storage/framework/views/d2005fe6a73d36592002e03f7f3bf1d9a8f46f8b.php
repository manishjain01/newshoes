...
<!--                             <img src="img/1.png">-->
                     ...
                     <?php if(isset($cart_detail->discount) && !empty($cart_detail->discount) && $cart_detail->discount != 0.00): ?>
                         <i class="fa fa-inr" aria-hidden="true"></i> <span><?php echo e(number_format($cart_detail->discount*$cart_detail->qty,2)); ?> </span>                         
                         <?php else: ?>
                         0
                         <?php endif; ?>  
                     </td>
...
<!--                                <span></span>-->
                     ...
                     <td class="input_p">
                       ...
                       <span class="cart_message<?php echo e($cart_detail->id); ?> error"></span>
<!--                        <p> <input type="number" name="quantity" min="1" max="5" placeholder="1"></p>-->
                     </td>
                     <td class="totl_p"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo e(number_format($cart_detail->price*$cart_detail->qty,2)); ?>  
<!--                         <a href="#" class="remov">X</a>-->
                     ...
                     <td class="remove_tdd"> 
                      <a href="javascript::void(0);" class="remov remove" id="remove_id" data-id = "<?php echo e($cart_detail->id); ?>">Remove</a>
            ...
            <div class="row shopping_row">
               <div class="col-md-3 block animatable bounceInLeft">
                  <a href="<?php echo e(URL::to('/')); ?>" class="btn_continue"><span>Continue Shopping</span></a>
               </div>
               ...
               <div class="col-md-6">
                  <table class="block animatable moveUp">
                     ...
                     <tr>
                        ...
                        <td class="">Rs. <?php echo e(number_format($total+$discount_price,2)); ?></td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td class="">Rs. <?php echo e(number_format($discount_price,2)); ?></td>
                     </tr>
                      <?php endif; ?>
                     ...
                     <tr class="total">
                        <td class="">Total</td>
                        <td class="">Rs. <?php echo e(number_format($grand_total,2)); ?></td>
                     </tr>
                  </table>
                   <?php if(Auth::check()): ?>
                   <a  <?php if($stock == 0){?>href="javascript:void(0)" onclick="alert('This product quantity not available in stock')"<?php }else{?> href="<?php echo e(URL::to('checkout')); ?>" <?php }?> id="checkout_cart" class="btn_continue1 btn_continue3 block animatable bounceInLeft">
                     ...
                     <br /><br /><br />
                     <a <?php if($stock == 0){?>href="javascript:void(0)" onclick="alert('This product quantity not available in stock')"<?php }else{?>href="<?php echo e(URL::to('guest_checkout')); ?>"<?php }?>  id="checkout_cart" class="btn_continue1 btn_continue3 block animatable bounceInLeft">Continue as a guest</a>
                     <?php endif; ?>
