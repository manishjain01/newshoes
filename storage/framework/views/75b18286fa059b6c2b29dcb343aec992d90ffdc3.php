...
<!--                        <h3 class="add_heading block animated moveUp">
                    ...
                    <div class="col-md-12 edit_home">
                        <?php echo Form::model($order,['route'=>['updateDeliveryAddress',$order->id,$page],'files'=>true,'id' =>'edit_form','style'=>'display:block']); ?>   
                         <?php echo csrf_field(); ?>
                         ...
                         <div class="form-group col-md-6" style="min-height:88px;">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <button type="button" class="btn btn-default clnc" onClick="location.href ='<?php echo e($url); ?>';">Cancel</button>
                            </div>
                          <?php echo Form::close(); ?>
